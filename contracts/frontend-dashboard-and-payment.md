...
| الحالة | الكود | الجسم |
|---|---|---|
| نجاح | `200` | `{ "message": "تم الدفع بنجاح.", "amount": 25.0, "balance": 75.0 }` |
| رصيد غير كافٍ | `402` | `{ "message": "رصيدك لا يكفي لدفع رسوم السكن.", "amount": 25.0 }` |
| الطلب غير مقبول بعد | `400` | `{ "message": "لا يمكن الدفع إلا بعد قبول طلب التسكين." }` |
| مدفوع مسبقًا | `409` | `{ "message": "تم دفع رسوم هذا الطلب مسبقاً.", "amount": 25.0 }` — `amount` = المبلغ المدفوع سابقاً |
...
`amount` = الرسم المتوجّب على هذا الطلب (ما خُصم / ما كان سيُخصم). يظهر في `200` و`402` و`409 مدفوع مسبقًا`. للعرض قبل الدفع: استخدم `feeAmount` من `HousingRequestDto` (§7).
