...
**housing-service · تحديث 2026‑09‑02 · ✅ منشور وحيّ على `housingservice001.runasp.net` وعبر البوابة.**
...
منشور وحيّ (2026‑09‑02): `POST /api/allocations/auto-assign` يرجع `401` بدون توكن على البوابة (الروت موجود)، وهجرتا `RejectionReason` + `AllowGroupReallocationAfterVacate` مطبَّقتان على `db64974`. لقطة البيانات الفعلية في **القسم 4**.
...
> هذه النقاط منشورة وحيّة على `housingservice001.runasp.net` وعبر البوابة اعتبارًا من 2026‑09‑02.
